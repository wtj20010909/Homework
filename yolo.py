...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            if predicted_class == 'battery':
                predicted_trash_class = 'Harmful Waste'
            elif predicted_class == 'plastic bottle' or predicted_class == 'can':
                predicted_trash_class ='Recyclable Waste'
            elif predicted_class == 'fruit' or predicted_class == 'vegetable':
                predicted_trash_class = 'Kitchen Waste'
            elif predicted_class == 'china' or predicted_class == 'cigarette':
                predicted_trash_class = 'Other Waste'

            # 画框框
            label = '{} {} {:.2f} {} {}'.format(predicted_class, 'score:', score, 'trash_class:', predicted_trash_class)
    ...
    def out_predicted_class(self, image):
        # ---------------------------------------------------------#
        #   给图像增加灰条，实现不失真的resize
        #   也可以直接resize进行识别
        # ---------------------------------------------------------#
